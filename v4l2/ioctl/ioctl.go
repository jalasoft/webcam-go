...
const (
	...
	//VIDIOC_QUERYFMT        = ((IOC_READ | IOC_WRITE) << IOC_DIR_SHIFT) | (uintptr('V') << IOC_TYPE_SHIFT) | (2 << IOC_NR_SHIFT) | ((unsafe.Sizeof(v4l2_fmtdesc{})) << IOC_SIZE_SHIFT)
...
func ReadCapability(fd uintptr) (v4l2.V4l2Capability, error) {
