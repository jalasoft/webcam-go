...
const (
	...
	VIDIOC_S_FMT           = ((IOC_READ | IOC_WRITE) << IOC_DIR_SHIFT) | (uintptr('V') << IOC_TYPE_SHIFT) | (5 << IOC_NR_SHIFT) | (unsafe.Sizeof(v4l2.V4l2PixFormat{}) << IOC_SIZE_SHIFT)
...
func SetFrameSize(fd uintptr, str *v4l2.V4l2PixFormat) (bool, error) {
